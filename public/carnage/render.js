...
//var TOGGLE_CLEAR = '9'.charCodeAt(0);
//var TOGGLE_BOX = '9'.charCodeAt(0);
//var TOGGLE_UNDO_BOX = '9'.charCodeAt(0);
//var TOGGLE_FLIPFLOP = '9'.charCodeAt(0);
//var TOGGLE_RENDER = '9'.charCodeAt(0);
...
function render(ctx) {
    ...
    */
    ...
    if (g_doClear) {
      ...
      bground.draw(ctx);
			ctx.drawImage(g_images.background, 0, g_canvas.height - g_images.background.height+20);
